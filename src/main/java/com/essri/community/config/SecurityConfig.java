package com.essri.community.config;

import com.essri.community.domain.SocialType;
import com.essri.community.oauth.ClientResources;
import com.essri.community.oauth.UserTokenService;
...
import static com.essri.community.domain.SocialType.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Filter oauth2Filter() {
        ...
        filters.add(oauth2Filter(facebook(), "/login/facebook", FACEABOOK));
